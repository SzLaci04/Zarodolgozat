...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 14, 2022 at 09:36 PM
...
INSERT INTO `meretek` (`meretId`, `meret`) VALUES
(1, '30x40cm'),
(2, '40x40cm'),
(3, '20x50cm'),
(4, '30x50cm'),
...
--
ALTER TABLE `meretek`
  MODIFY `meretId` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
